...
function EverypayModal(EVDATA) {
    ...
    this.createSaveCardCheckbox = function() {
        var payformDiv = document.querySelector('#everypay-modal-content');
        if (!payformDiv || document.getElementById('everypay-save-card-box')) {
            return;
        }
        var saveCardBox = document.createElement('div');
        ...
        saveCardCheckbox.addEventListener('click', function(event) {
            try {
        ...
        var saveCardText = document.createElement('label');
